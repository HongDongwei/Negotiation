...
public class PreferencesWrapper {
    ...
    public final static HashMap<String, String> STRING_PREFS = new HashMap<String, String>() {
...

        {
            ...
            put(SipConfigManager.H264_PROFILE, "77");
            put(SipConfigManager.H264_LEVEL, "31");
            ...
            //218.108.119.242
            put(SipConfigManager.STUN_SERVER, "mvcs.zjhzyh.cn");
            put(SipConfigManager.TURN_SERVER, "60.191.75.54:3478");
...
//          put(SipConfigManager.TURN_SERVER, "218.108.119.242:3478");
            ...
            put(SipConfigManager.TURN_PASSWORD, "ling1234");
            put(SipConfigManager.TURN_TRANSPORT, "1");
    ...
    private final static HashMap<String, Boolean> BOOLEAN_PREFS = new HashMap<String, Boolean>() {
...

        {
            ...
            put(SipConfigManager.ENABLE_DNS_SRV, true);
            put(SipConfigManager.ENABLE_ICE, true);
            put(SipConfigManager.ICE_AGGRESSIVE, true);
            put(SipConfigManager.ENABLE_TURN, true);
...
//		put(SipConfigManager.USE_ANYWAY_OUT, false);
            ...
            put(SipConfigManager.AUTO_CONNECT_SPEAKER, true);
            put(SipConfigManager.AUTO_DETECT_SPEAKER, true);
...
//		    put(SipConfigManager.INTEGRATE_WITH_DIALER, true);
    ...
    private final static HashMap<String, Float> FLOAT_PREFS = new HashMap<String, Float>() {
...

        {
            ...
            put(SipConfigManager.SND_SPEAKER_LEVEL, (float) 6.0);
